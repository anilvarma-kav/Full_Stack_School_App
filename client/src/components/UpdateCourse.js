                                ...
                                <div className="grid-66">
                                    <div className="course--header">
                                        ...
                                        <div><input id="title" name="title" type="text" value={title}
                                                    className="input-title course--title--input" onChange={this.change}
                                    ...
                                    <div className="course--description">
                                        <div><textarea id="description" name="description" value={description}
                                                       onChange={this.change} placeholder="Course description..."/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul className="course--stats--list">
                                            <li className="course--stats--list--item">
                                                ...
                                                <div><input id="estimatedTime" name="estimatedTime" type="text"
                                                            value={estimatedTime}
                                                            className="course--time--input" onChange={this.change}
                                                            placeholder="Hours"/>
                                                </div>
                                            </li>
                                            <li className="course--stats--list--item">
                                                ...
                                                <div><textarea id="materialsNeeded" name="materialsNeeded"
                                                               ...
                                                               onChange={this.change} placeholder="List materials..."/>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
